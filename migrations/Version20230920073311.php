 ...
 */
final class Version20230920073311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT NOT NULL, executor_id INT NOT NULL, parent_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, priority INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP CONSTRAINT FK_527EDB258ABD09BB');
